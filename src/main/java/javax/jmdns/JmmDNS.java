...
/**
 * <p> Java Multihomed Multicast DNS </p> Uses an underlying {@link JmDNS} instance for each {@link
 * InetAddress} found on this computer.<br/> This class will monitor network topology changes, and
 * will create or destroy JmDNS instances as required. It is your responsibility to maintain
 * services registration (hint: use a {@link NetworkTopologyListener}).<br/> Most of this class
 * methods have no notion of transaction: if an Exception is raised in the middle of execution, you
 * may be in an incoherent state. <p> <b>Note:</b> This API is experimental and may change in the
 * future please let us know what work and what does not work in your application. </p>
 *
...
public interface JmmDNS extends Closeable {
   ...
   * the service may be changed to make it unique.<br> <b>Note</b> the Service info is cloned for
   ...
   * be notified of the new service type. Service types are automatically registered as they are
   * discovered.
   *
   * @param type full qualified service type, such as <code>_http._tcp.local.</code>.
