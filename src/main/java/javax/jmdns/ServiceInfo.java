...
/**
 * <p> The fully qualified service name is build using up to 5 components with the following
 * structure:
 *
 * <pre>
 ...
 * </pre>
 *
 * <ol> <li>&lt;servicedomain&gt;.&lt;parentdomain&gt;: This is the domain scope of the service
 * typically "local.", but this can also be something similar to "in-addr.arpa." or "ip6.arpa."</li>
 * <li>&lt;protocol&gt;: This is either "_tcp" or "_udp"</li> <li>&lt;app&gt;: This define the
 * application protocol. Typical example are "_http", "_ftp", etc.</li> <li>&lt;Instance&gt;: This
 * is the service name</li> <li>&lt;sub&gt;: This is the subtype for the application protocol</li>
 * </ol> </p>
 */
public abstract class ServiceInfo implements Cloneable {
   ...
   * @param type fully qualified service type name, such as <code>_http._tcp.local.</code>.
   * @param name unqualified service instance name, such as <code>foobar</code>
   * @param subtype service subtype see draft-cheshire-dnsext-dns-sd-06.txt chapter 7.1 Selective
  ...
  /**
   * Construct a service description for registering with JmDNS. The properties hashtable must map
   ...
   */
  public static ServiceInfo create(final String type, final String name, final int port,
      final int weight, final int priority, final boolean persistent, final Map<String, ?> props) {
   ...
   * property names to either Strings or byte arrays describing the property values.
   *
   * @param qualifiedNameMap dictionary of values to build the fully qualified service name.
   * Mandatory keys are Application and Instance. The Domain default is local, the Protocol default
   * is tcp and the subtype default is none.
   * @param port the local port on which the service runs
   * @param weight weight of the service
   * @param priority priority of the service
   * @param persistent if <code>true</code> ServiceListener.resolveService will be called whenever
   ...
   * <code>_printer._sub._http._tcp.local.</code>
   *
   * @return service type name
   */
  ...
  /**
   * Get the InetAddress of the service. This will return the IPv4 if it exist, otherwise it return
   * the IPv6 if set.<br/> <b>Note:</b> This return null if the service IP address cannot be
   * resolved.
   *
  ...
  /**
   * Get the text for the service. This will interpret the text bytes as a UTF8 encoded string. Will
   * return null if the bytes are not a valid UTF8 encoded string.<br/> <b>Note:</b> Do not use.
   * This method make the assumption that the TXT record is one string. This is false. The TXT
   * record is a series of key value pairs.
   *
   * @return service text
  ...
  /**
   * Get the URL for this service. An http URL is created by combining the address, port, and path
   * properties.
   *
   * @return service URL
   * @see #getURLs()
  ...
  /**
   * Get the list of URL for this service. An http URL is created by combining the address, port,
   * and path properties.
   *
  ...
  /**
   * Get the URL for this service. An URL is created by combining the protocol, address, port, and
   * path properties.
   *
  ...
  /**
   * Get the list of URL for this service. An URL is created by combining the protocol, address,
  ...
  /**
   * Get a property of the service. This involves decoding the text bytes into a property list.
   * Returns null if the property is not found or the text data could not be decoded correctly.
   *
  ...
  /**
   * Get a property of the service. This involves decoding the text bytes into a property list.
   * Returns null if the property is not found, the text data could not be decoded correctly, or the
   * resulting bytes are not a valid UTF8 string.
   *
   * @param name property name
  ...
  /**
   * Returns <code>true</code> if ServiceListener.resolveService will be called whenever new new
