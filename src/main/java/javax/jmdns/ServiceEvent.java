...
public abstract class ServiceEvent extends EventObject implements Cloneable {
  ...
  /**
   * Returns the instance name of the service. Always returns null, if the event is sent to a
  ...
  /**
   * Returns the service info record, or null if the service could not be resolved. Always returns
   * null, if the event is sent to a service type listener.
   *
