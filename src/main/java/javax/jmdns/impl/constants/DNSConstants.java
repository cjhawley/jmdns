...
public final class DNSConstants {
  ...
  // Operation code
  public static final int FLAGS_OPCODE = 0x7800;
  ...
  // Response code
  public static final int FLAGS_RCODE = 0x000F;
  ...
  // We only increment the throttle count, if the previous increment is inside this interval.
  ...
  // This is 1s delay used in ttl and therefore in seconds
  ...
  // 10 seconds
  public static final int NETWORK_CHECK_INTERVAL =  10 * 1000;
