...
public enum DNSState {
  ...
  /**
   * Returns the next advanced state.<br/> In general, this advances one step in the following
   * sequence: PROBING_1, PROBING_2, PROBING_3, ANNOUNCING_1, ANNOUNCING_2, ANNOUNCED.<br/> or
   * CANCELING_1, CANCELING_2, CANCELING_3, CANCELED Does not advance for ANNOUNCED and CANCELED
   * state.
   *
   * @return next state
   */
