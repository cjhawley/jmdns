...
public abstract class DNSResolverTask extends DNSTask {
  ...
  /**
   * Overridden by subclasses to add questions to the message.<br/> <b>Note:</b> Because of message
   * size limitation the returned message may be different than the message parameter.
   *
