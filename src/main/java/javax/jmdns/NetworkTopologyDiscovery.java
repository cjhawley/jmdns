...
/**
 * This class is used to resolve the list of Internet address to use when attaching JmDNS to the
 * network. <p> To create you own filtering class for Internet Addresses you will need to implement
 * the class and the factory delegate. These must be called before any other call to JmDNS.
 *
 * <pre>
 ...
 *
 *     &#064;Override
 *     public boolean useInetAddress(NetworkInterface networkInterface, InetAddress
 * interfaceAddress) {
 *         // TODO Auto-generated method stub
 *         return false;
 *     }
...
public interface NetworkTopologyDiscovery {
  ...
  final class Factory {
    ...
    /**
     * Assigns <code>delegate</code> as NetworkTopologyDiscovery's class delegate. The class
